...
- **Límite de Archivo:** Ningún archivo de código fuente puede exceder las **500 líneas**.
  - _Acción:_ Si un archivo crece más allá, debe refactorizarse y dividirse en submódulos.
- **Documentación:**
...
- **Rustfmt:** Formateador de código oficial.
  - _Configuración:_ `edition = "2021"`, `max_width = 100`.
